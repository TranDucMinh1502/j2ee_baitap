...
import fit.hutech.TranDucMinh.daos.Cart;
import fit.hutech.TranDucMinh.entities.Book;
import fit.hutech.TranDucMinh.entities.Invoice;
...
import fit.hutech.TranDucMinh.services.VoucherService;
...
public class CartController {
    ...
    public String updateQuantity(@PathVariable Long id,
        ...
        // Validation: Số lượng không quá 100
        if (quantity > 100) {
            redirectAttributes.addFlashAttribute("errorMessage", "Số lượng không được vượt quá 100!");
            return "redirect:/cart";
        }
    ...
    public String processCheckout(HttpSession session, 
        ...
        try {
            ...
            var appliedVoucher = (fit.hutech.TranDucMinh.entities.Voucher) null;
