package fit.hutech.TranDucMinh.exception;

import fit.hutech.TranDucMinh.dto.ErrorResponse;
...
@RestControllerAdvice(basePackages = "fit.hutech.TranDucMinh.controllers.rest")
